...
def parse_nodewatcher_xml(xml):
	try:
		...
		router_update = {
			...
			"clients_eth": evalxpathint(tree,"/data/clients/*[starts-with(name(), 'eth')]/text()"),
			"clients_w2": evalxpathint(tree,"/data/clients/w2ap/text()"),
			"clients_w5": evalxpathint(tree,"/data/clients/w5ap/text()"),
			"has_wan_uplink": (
